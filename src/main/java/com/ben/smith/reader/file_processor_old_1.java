 ...
 */
class file_processor_old_1 {

    // Takes in a filename and returns the assets from that file
    static List<Asset> get_assets(String file_name) {
        file_processor_old_1 f = new file_processor_old_1();

        List<String> valuable_lines = f.read_old_1(file_name);
